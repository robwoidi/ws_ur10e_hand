...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "${prefix}/include;/opt/ros/noetic/include/libfranka;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3".split(';') if "${prefix}/include;/opt/ros/noetic/include/libfranka;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3" != "" else []
